	...
	return (
		...
		>
			<Menu.Item key={`${match.url}/edit-profile`}>
				<UserOutlined />
				<span><IntlMessage id={"account.sidenav.EditProfile"}/></span>
				<Link to={'edit-profile'} />
			</Menu.Item>
			<Menu.Item key={`${match.url}/change-password`}>
				<LockOutlined />
				<span><IntlMessage id={"account.sidenav.ChangePassword"}/></span>
				<Link to={'change-password'} />
			</Menu.Item>
			<Menu.Item key={`${match.url}/billing`}>
				<CreditCardOutlined />
				<span><IntlMessage id={"account.sidenav.Billing"}/></span>
				<Link to={`billing`} />
			</Menu.Item>
			<Menu.Item key={`${match.url}/notification`}>
				<BellOutlined />
				<span><IntlMessage id={"account.sidenav.Notification"}/></span>

	...
	return (
		<div className="h-100 bg-white">
			<div className="container-fluid d-flex flex-column justify-content-between h-100 px-md-4 pb-md-4 pt-md-1">
				<div>
					<img className="img-fluid" src={process.env.PUBLIC_URL + "/img/rsz_is-logo-dark.png"} alt="" />
				</div>
				<div className="container">
					<Row align="middle">
						...
						<Col xs={24} sm={24} md={{ span: 14, offset: 2 }}>
							<img className="img-fluid mt-md-0 mt-4" src={process.env.PUBLIC_URL + "/img/others/img-20.png"} alt="" />
						</Col>
					</Row>
				</div>

...
/* Get data from API and fix types */
...
const MapChart = ({ setTooltipContent, data, mapSource, mapType }: any) => {
    return (
        <ComposableMap
            style={{
                transform: `${
                    mapType === "world" ? "translateY(20px)" : "none"
                }`,
            }}
            data-tip=""
            height={380}
...
export const RegiondataWidget = (props: any) => {
